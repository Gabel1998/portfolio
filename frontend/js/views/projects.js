            ...
            return `
                <div class="project-card">
                    ...
                    <div class="project-card__links">
                        ...
                        ${project.liveUrl && !project.showroomPath && project.liveUrl.replace(/\/$/, '') !== window.location.origin ? `<a href="${project.liveUrl}" target="_blank" rel="noopener" class="project-card__link" data-i18n="projects.visitSite">${I18n.t('projects.visitSite')}</a>` : ''}
